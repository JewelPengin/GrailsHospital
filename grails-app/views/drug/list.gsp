			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="drugName" title="${message(code: 'drug.drugName.label', default: 'Drug Name')}" />
				...
				<g:each in="${drugInstanceList}" status="i" var="drugInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${drugInstance.id}">${fieldValue(bean: drugInstance, field: "drugName")}</g:link></td>

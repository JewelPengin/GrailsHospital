<html>
	...
	<body>
		...
		<section>
			...
			<cl:grid name="MyGrid" dataUrl="null" data="${[list: [[col1: 'data 1', col2: 'data 2', col3: 'data 3'], [col1: 'data 4', col2: 'data 5', col3: 'data 6'], [col1: 'data 7', col2: 'data 8', col3: 'data 9']], count: 3]}">
